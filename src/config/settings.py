...
TARGET_FPS_PLATE = 30    # FPS objetivo cuando se detecta una placa (aumentado para mayor fluidez)
...
PLATE_COOLDOWN_TIME = 10.0  # Segundos antes de registrar la misma placa nuevamente
...
SIMILARITY_THRESHOLD = 0.80  # Umbral para considerar dos placas como similares (0-1)
...
MULTITHREADED_OCR = True  # Usar procesamiento en hilos para OCR (experimental)
